...
#
# Generated by export_simulation on Tue Jun 20 10:25:54 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './DPRAM.sh' script.
...
./DPRAM.sh -noclean_files

For more information on the script, please type './DPRAM.sh -help'.
